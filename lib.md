...
| github.com/testcontainers/testcontainers-go | **v0.31.0** (dev tool; implementada em E0a) | testes de integração com containers reais | suíte de testes (PG + Redis + RabbitMQ), ADR 0006 | módulos oficiais, Testcontainers padrão, reproduzibilidade | mocks (não validam SQL), docker-compose manual | startup lento (mitigado: container por suíte) | nenhuma | 2026-07-08 (OSV) | https://golang.testcontainers.org |
